...
public class MainRolesState : RolesBaseState
{
    public ICollection<RoleDto>? ListItems;
    

    public RoleDto? SelectedItem;
    ...
    private async Task GetData()
    {
        ...
        ListItems = new List<RoleDto>();
        var res = await Service.GetRoles(query);
    ...
    public void ShowEditCreate(RoleDto? item)
    {
        SelectedItem = item;
